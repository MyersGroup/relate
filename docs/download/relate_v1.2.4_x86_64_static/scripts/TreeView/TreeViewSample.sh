...
then
  ...
  echo "--mut:            Filename of mut file."
	echo "--dist:           Filename of dist file."
...
PATH_TO_RELATE=$0
PATH_TO_RELATE=$(echo ${PATH_TO_RELATE} | awk -F\scripts/TreeView/TreeViewSample.sh '{print $1}')
